...
# training data
csv_file = '/raid/users/mohammadibrahim-st/TSAI/Capstone/era_capstone/3finetuning/train_token.csv'
...
file = open('/raid/users/mohammadibrahim-st/TSAI/Capstone/era_capstone/3finetuning/sample_val_data.csv')
